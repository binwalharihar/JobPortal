<%@ Page Title="" Language="C#" MasterPageFile="~/JobRecruiter.Master" AutoEventWireup="true" CodeBehind="JobRecruiterJobPostShow.aspx.cs" Inherits="job_portal.JobRecruiterModule.ListofJob" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td>
                <asp:GridView runat="server" ID="gvjobpost" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="gvjobpost_RowCommand">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField >
                            <ItemTemplate>
                                <asp:Button  runat="server" ID="btndel" Text="Delete" CommandName="A" CommandArgument='<%#Eval("JobPostId") %>'/>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField >
                            <ItemTemplate>
                                <asp:Button  runat="server" ID="btnedit" Text="Edit"  CommandName="B" CommandArgument='<%#Eval("JobPostId") %>'/>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
